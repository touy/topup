...
var __desing={
  ...
  "views": {
    ...
    "authentication": {
      "map": "function(doc) {\r\n    if(doc.username) {\r\n        emit([doc.username,doc.password],1);\r\n    }\r\n}",
      "reduce": "_count"
    },
    "findByUserAndPhone": {
...
module._findUsername=function(p,cb){
  if(cb){
    db.view(__designview,"findByUsername",{
      ...
      db.view(__designview,"findByUsername",{
        key: [p.username]},handle_result);
  }
}
module._findIntroductorcode=function(p,cb){

if(cb){
    db.view(__designview,"findByIntroductorcode",{
      key: [p.introductorcode]      
      },cb);
  }
else{
    db.view(__designview,"findByIntroductorcode",{
      key: [p.introductorcode]},handle_result);
  }
